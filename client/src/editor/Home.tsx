  ...
  return (
    <div className="w-screen h-screen overflow-auto bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <section className="max-w-3xl mx-auto px-6 mt-12 mb-6">
        ...
        {!hasValidConfig() && (
          <div className="mb-4 px-4 py-3 rounded-xl bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 flex items-center gap-3">
            <div className="flex-shrink-0 w-9 h-9 rounded-full bg-white/70 border border-purple-200 flex items-center justify-center">
            ...
            <button
              ...
              className="flex-shrink-0 px-3 py-1.5 text-xs font-medium rounded-lg bg-purple-600 hover:bg-purple-700 text-white"
            >
              {t("onboarding.cta")}
            </button>
          </div>
